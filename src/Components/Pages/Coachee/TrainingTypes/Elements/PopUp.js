...
export default function PopUpPeriodizacao(props) {
    ...
    const body = (
        <div style={modalStyle} className={classes.paper}>
            ...
            <div style={{ color: '#632467', position:'absolute', top:'-17px', right:'15px', backgroundColor:'white', borderRadius:'50%' }}
                 onClick={handleClose}
            >
            ...
            <div className={classes.CadeiaContainer}>
                <div className={classes.CadeiaRow}>
                    ...
                    <div className={classes.descriptionText}>
                        É a fase do movimento em que freamos o peso/resistência
                        contra a gravidade. É o primeiro número da cadência.
                    </div>
                </div>
                <div style={{ width: "20%" }}>
                ...
                <div className={classes.CadeiaRow}>
                    ...
                    <div className={classes.descriptionText}>
                        ...
                        erguer/puxar/empurrar o peso contra gravidade. É o
                        segundo número da cadência.
                    </div>
                </div>
            </div>
        </div>
