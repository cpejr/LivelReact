...
let percentCardio = (((currentcardio - lastcardio) / lastcardio) * 100).toFixed(
  0
);
let percentPeso = (((currentpeso - lastpeso) / lastpeso) * 100).toFixed(0);
let percentGordura = (
  ((currentgordura - lastgordura) / lastgordura) *
  100
).toFixed(0);
...
export class CurrentMonth extends React.Component {
  ...
  render() {
    return <div className="thisMonth">{this.state.thisMonth}</div>;
  }
}
...
export class LastMonth extends React.Component {
  ...
  render() {
    return <div className="lastsMonth">{this.state.lastMonth}</div>;
  }
}
      ...
      <div className="resultsRow">
        <div className="ResultsBox">
          <div className="boxHeader">
            ...
            <StyleForcaPercent
              isPositive={percentForca}
              className="percentType"
            />
          </div>
