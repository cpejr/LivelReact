export function AllRestriction(props) {
  return (
    <>
      <ul className="restricoesescritas">
        {props.cabeca != null && <li className="cabeca"> Cabeça </li>}

        {props.pescoco != null && <li className="pescoco"> Pescoço </li>}

        {props.coluna != null && <li className="coluna"> Coluna </li>}

        {props.coracao != null && <li className="coracao"> Coração </li>}

        {props.quadril != null && <li className="quadril"> Quadril </li>}
